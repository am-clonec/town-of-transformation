...
public static class NormalAssets
{
    ...
    public static LoadableBundleAsset<AnimationClip> RichGuyWalkAnimation { get; } = new("RichGuyWalk.anim", Bundle);
    public static LoadableBundleAsset<AnimationClip> StatueAnimation { get; } = new("statue.anim", Bundle);
