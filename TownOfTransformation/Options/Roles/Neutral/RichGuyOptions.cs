...
public sealed class RichGuyOptions : AbstractOptionGroup<RichGuyRole>
{
    ...
    [ModdedNumberOption("Maximum Extra Lives", 0f, 5f, 1f, MiraNumberSuffixes.None, zeroInfinity:true)]
    ...
    public float MaxGoldifyUses { get; set; } = 0;
    ...
    public float MaxRevealUses { get; set; } = 3;
    ...
    public float MaxZoomoutUses { get; set; } = 3;
